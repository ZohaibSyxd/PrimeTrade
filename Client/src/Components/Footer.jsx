  ...
  return (
    <motion.footer initial={isPC && {opacity:0,y:100}} transition={ isPC && {delay:.5,duration:.5}} whileInView={ isPC && {opacity:1,y:0}} viewport={{once:true}} className="footer">
      <div className="footer__content">
        ...
        <div className="footer__section">
          <h3>About Us</h3>
          <p>PrimeTrade is your go-to destination for the latest trends in fashion, tech, and home decor. With a curated selection of high-quality products and exceptional customer service, we're here to help you express your unique style.</p>
        </div>
        <div className="footer__section">
          <h3>Contact</h3>
          <p>Email: zohaibasim20@gmail.com</p>
          <p>Phone:91xxxxxxxx</p>
          <p>Address: 123 Main Street, City, Country</p>
        </div>
      </div> 
      <div className="footer__developers">
        <p>Developed with <span role="img" aria-label="heart">❤️</span> by <Link to={'https://github.com/ZohaibSyxd'} target="_blank" rel="noopener noreferrer">Zohaib Syed</Link></p>
      </div>
